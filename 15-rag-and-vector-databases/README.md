...
Два подхода при внедрении RAG согласно предлагаемому документу ["Поисково-дополненная генерация для наукоемких задач НЛП (программного обеспечения обработки естественного языка)"](https://arxiv.org/pdf/2005.11401.pdf?WT.mc_id=academic-105485-koreyst) :
